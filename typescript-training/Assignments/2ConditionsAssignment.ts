/****************************************************************************************************************************************
    ...
    Create common function and then based on below details, print whether user is eligible to get 
    the loan or not
...
function loanEvaluation(
  ...
  dtiRatio: number,
    ...
    if (creditScore > 750 && isEmployed && income >= 50000) {
        if (dtiRatio < 40.0) {
            console.log(`Load of ${customerName} Approved`);
        } else {
            console.log(`Loan of ${customerName} Denied`);
        }
    } else if (creditScore <= 750 && creditScore >= 650 && income >= 50000 && isEmployed) {
        if (dtiRatio < 40.0) {
            console.log(`Load of ${customerName} Approved`);
        } else {
            console.log(`Loan of ${customerName} Denied`);
...
loanEvaluation("John Doe", 720, 55000.0, true, 35.0);